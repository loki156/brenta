 ...
 * @return void
 */
function brenta_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function brenta_customize_partial_blogdescription() {
...
function brenta_customize_preview_js() {
	wp_enqueue_script( 'brenta-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
